...
- ✅ Incorporació de la Roser a l'equip (disseny + programació + BD)

### Properes accions (aquesta setmana)
- [ ] Paolo: donar accés a la Roser al repositori GitHub
- [ ] Paolo: explicar a la Roser el model de treball amb Z.ai-bot (GitHub com a cervell compartit)
- [ ] Roser: llegir els 14 documents del repo per posar-se al dia
...
- [ ] Paolo: explicar a la Roser el model de treball
- [ ] Roser: llegir documentació del repo
...
- [ ] Roser: tancar disseny de pàgines internes (/informes, /informes/[slug], /sobre-nosaltres, /faq)
...
- [ ] Roser: implementar autenticació (Supabase Auth)
- [ ] Roser: implementar base de dades (Supabase PostgreSQL + Prisma)
...
- [ ] Roser: integrar Stripe (sense activar encara)
- [ ] Roser: provar flux de registre + login complet
...
- [ ] Roser: donar accés als beta testers (credencials o registre)
...
- [ ] Roser: iterar disseny segons feedback
- [ ] Roser: corregir bugs detectats
...
- [ ] Roser: deploy final a producció (criteriesg.com)
...
- [ ] Roser: iteracions basades en comportament d'usuari
...
- [ ] Roser: implementar el sistema de paywall (preparat per a novembre)
- [ ] Roser: implementar tracker de places early bird (50 places)
...
- [ ] Roser: monitorar conversió prova gratis → Premium
...
- [ ] Roser: optimitzar pàgina de vendes
...
- Suport tècnic puntual a la Roser
...
- **29 juny 2026** — Roadmap revisat completament. Calendari juliol-setembre 2026 detallat. Repartiment de responsabilitats amb la Roser. Newsletter bimensual confirmada. Early bird 2 mesos + paywall progressiu.
