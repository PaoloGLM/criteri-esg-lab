...
const standards: Standar[] = [
  { slug: "csrd-esrs", name: "CSRD / ESRS", type: "reg", access: "free", count: 10, descCa: "Directiva de reporting de sostenibilitat de la UE. Afecta ~11.500 empreses espanyoles.", descEs: "Directiva de reporting de sostenibilidad de la UE. Afecta a ~11.500 empresas españolas." },
  { slug: "csddd", name: "CSDDD", type: "reg", access: "free", count: 4, descCa: "Deure de diligència en drets humans per a empreses >1000 empleats.", descEs: "Deber de diligencia en derechos humanos para empresas >1000 empleados." },
  { slug: "sfdr", name: "SFDR", type: "reg", access: "free", count: 3, descCa: "Regulació de disclosure financer. Articles 6, 8 i 9.", descEs: "Regulación de disclosure financiero. Artículos 6, 8 y 9." },
  { slug: "taxonomia-ue", name: "Taxonomía UE", type: "reg", access: "free", count: 5, descCa: "Classificació d'activitats econòmiques sostenibles. 6 objectius.", descEs: "Clasificación de actividades económicas sostenibles. 6 objetivos." },
  { slug: "emas", name: "EMAS", type: "reg", access: "free", count: 2, descCa: "Sistema comunitari d'eco-gestió i auditoria. UE.", descEs: "Sistema comunitario de eco-gestión y auditoría. UE." },
  { slug: "gri", name: "GRI", type: "fw", access: "free", count: 8, descCa: "Global Reporting Initiative. Estàndard més usat a Espanya.", descEs: "Global Reporting Initiative. Estándar más usado en España." },
  { slug: "sasb", name: "SASB", type: "fw", access: "free", count: 3, descCa: "Framework de reporting per indústria. 77 indústries.", descEs: "Framework de reporting por industria. 77 industrias." },
  { slug: "tnfd", name: "TNFD", type: "fw", access: "free", count: 4, descCa: "Framework de natura. Riscos i dependències.", descEs: "Framework de naturaleza. Riesgos y dependencias." },
  { slug: "tcfd", name: "TCFD", type: "fw", access: "free", count: 6, descCa: "Framework climàtic. Recomanacions de disclosure.", descEs: "Framework climático. Recomendaciones de disclosure." },
  { slug: "iso-26000", name: "ISO 26000", type: "fw", access: "free", count: 2, descCa: "Guia de responsabilitat social. No certificable.", descEs: "Guía de responsabilidad social. No certificable." },
  { slug: "ecovadis", name: "EcoVadis", type: "cert", access: "premium", count: 7, descCa: "Rating de sostenibilitat per a cadenes de subministrament.", descEs: "Rating de sostenibilidad para cadenas de suministro." },
  { slug: "b-corp", name: "B Corp", type: "cert", access: "premium", count: 5, descCa: "Certificació d'empreses amb propòsit de B Lab.", descEs: "Certificación de empresas con propósito de B Lab." },
  { slug: "msci-esg", name: "MSCI ESG", type: "cert", access: "premium", count: 6, descCa: "Rating ESG per a inversors (AAA-CCC).", descEs: "Rating ESG para inversores (AAA-CCC)." },
  { slug: "cdp", name: "CDP", type: "cert", access: "premium", count: 3, descCa: "Disclosure global de clima, aigua i boscos.", descEs: "Disclosure global de clima, agua y bosques." },
  { slug: "sge-21", name: "SGE 21", type: "cert", access: "premium", count: 3, descCa: "Sistema de Gestió Ètica de Forética. Metodologia espanyola.", descEs: "Sistema de Gestión Ética de Forética. Metodología española." },
  { slug: "sustainalytics", name: "Sustainalytics", type: "cert", access: "premium", count: 4, descCa: "Rating de risc ESG per a inversors. 5 nivells.", descEs: "Rating de riesgo ESG para inversores. 5 niveles." },
];
