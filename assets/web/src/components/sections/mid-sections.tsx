 ...
 *
 * Dues seccions en cream (var(--c-clar)), text var(--c-fosc):
 *
 ...
 *
 * Regles de disseny:
 * - Cada secció té border-top 3px solid var(--c-fosc)
      ...
      >
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <em className="italic font-normal" style={{ color: "var(--c-tinta)" }}>
