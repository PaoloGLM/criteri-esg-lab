...
export const translations = {
  ...
  "v2.popup.intro": {
    ca: "El semàfor no evalúa si un informe és bo o dolent. Evalúa si és útil per prendre decisions operatives en una empresa concreta. Ho fa en 5 dimensions, cadascuna amb nota verd, groga o vermella. La nota final va d'A (robust fort) a D (insuficient).",
    es: "El semáforo no evalúa si un informe es bueno o malo. Evalúa si es útil para tomar decisiones operativas en una empresa concreta. Lo hace en 5 dimensiones, cada una con nota verde, amarilla o roja. La nota final va de A (robusto fuerte) a D (insuficiente).",
  },
  "v2.popup.dim.1.name": { ca: "Scope 3", es: "Scope 3" },
  "v2.popup.dim.1.question": { ca: "¿Cobreix emissions indirectes?", es: "¿Cubre emisiones indirectas?" },
  "v2.popup.dim.1.exp": { ca: "En la majoria de sectors, el Scope 3 és entre el 70% i el 90% de l'empremta total. Un informe que l'ignora és tècnicament correcte però operativament inservible.", es: "En la mayoría de sectores, el Scope 3 es entre el 70% y el 90% de la huella total. Un informe que lo ignora es técnicamente correcto pero operativamente inservible." },
  ...
  "v2.popup.grade.b.desc": { ca: "4 verds + 1 groc", es: "4 verdes + 1 amarillo" },
  ...
  "quefem.hero.subtitle": { ca: "Sintetitzem, creuem i recomanem. Tres passos sobre els informes institucionals que afecten la teva empresa. Res més.", es: "Sintetizamos, cruzamos y recomendamos. Tres pasos sobre los informes institucionales que afectan a tu empresa. Nada más." },
  ...
  "quefem.proceso.01.desc": { ca: "Els informes institucionals més rellevants, en 5 minuts de lectura. Amb semàfor metodològic propi de 5 dimensions.", es: "Los informes institucionales más relevantes, en 5 minutos de lectura. Con semáforo metodológico propio de 5 dimensiones." },
  "quefem.proceso.02.verb": { ca: "Creuar", es: "Cruzar" },
  "quefem.proceso.02.desc": { ca: "Cada informe creuat amb les teves certificacions: EcoVadis, B Corp, MSCI, GRI, SGE 21, Sustainalytics. Et diem què t'afecta i amb quina intensitat.", es: "Cada informe cruzado con tus certificaciones: EcoVadis, B Corp, MSCI, GRI, SGE 21, Sustainalytics. Te decimos qué te afecta y con qué intensidad." },
  "quefem.proceso.03.verb": { ca: "Recomanar", es: "Recomendar" },
  "quefem.proceso.03.desc": { ca: "Tres accions concretes per informe. Operatives. Verificables. El criteri aplicat a la teva decisió d'aquesta setmana.", es: "Tres acciones concretas por informe. Operativas. Verificables. El criterio aplicado a tu decisión de esta semana." },
  ...
  "quefem.semaforo.desc": { ca: "No avaluem si un informe és bo o dolent. Avaluem si és útil per prendre decisions operatives en una empresa concreta. Cinc dimensions, una nota d'A a D. Transparent.", es: "No evaluamos si un informe es bueno o malo. Evaluamos si es útil para tomar decisiones operativas en una empresa concreta. Cinco dimensiones, una nota de A a D. Transparente." },
  ...
  "quisom.v2.hero.subtitle": { ca: "Aquesta és la gent que hi ha al darrere. Un equip petit que creu que les empreses poden ser agents de canvi —i que la tecnologia ha d'estar al servei del criteri humà.", es: "Esta es la gente que hay detrás. Un equipo pequeño que cree que las empresas pueden ser agentes de cambio —y que la tecnología debe estar al servicio del criterio humano." },
  ...
  "quisom.v2.team.intro": { ca: "Hem construït un sistema que combina el millor de la intel·ligència artificial amb la mirada ètica de persones que coneixen el sector ESG. La IA fa la feina pesada — recerca, síntesi, classificació. Les persones aportem criteri, context i judici.", es: "Hemos construido un sistema que combina lo mejor de la inteligencia artificial con la mirada ética de personas que conocen el sector ESG. La IA hace el trabajo pesado — investigación, síntesis, clasificación. Las personas aportamos criterio, contexto y juicio." },
  ...
  "quisom.v2.team.01.bio": { ca: "Combina formació en filosofia i gestió d'empreses, amb experiència en consultoria ESG. Decideix quins informes es processen, firma la Carta del Director mensual i manté la coherència editorial del projecte. La seva mirada ètica és el que diferencia Criteri d'altres serveis ESG.", es: "Combina formación en filosofía y gestión de empresas, con experiencia en consultoría ESG. Decide qué informes se procesan, firma la Carta del Director mensual y mantiene la coherencia editorial del proyecto. Su mirada ética es lo que diferencia a Criteri de otros servicios ESG." },
  ...
  "quisom.v2.team.02.bio": { ca: "S'encarrega del desenvolupament web (Next.js), la base de dades (Supabase), les integracions tècniques (Stripe, Beehiiv, Google Drive) i el manteniment de l'agent d'IA. Treballa estretament amb el fundador perquè la tecnologia estigui sempre al servei del criteri humà, no al revés.", es: "Se encarga del desarrollo web (Next.js), la base de datos (Supabase), las integraciones técnicas (Stripe, Beehiiv, Google Drive) y el mantenimiento del agente de IA. Trabaja estrechamente con el fundador para que la tecnología esté siempre al servicio del criterio humano, no al revés." },
  ...
  "quisom.v2.team.03.bio": { ca: "Fa la feina pesada —detecció de fonts, síntesi en 8 blocs, classificació, corrector ortogràfic— sempre sota supervisió humana. No és un membre de l'equip en sentit estricte, però sense ella no podríem mantenir el ritme de publicació ni el cost per informe que tenim.", es: "Hace el trabajo pesado —detección de fuentes, síntesis en 8 bloques, clasificación, corrector ortográfico— siempre bajo supervisión humana. No es un miembro del equipo en sentido estricto, pero sin ella no podríamos mantener el ritmo de publicación ni el coste por informe que tenemos." },
  ...
  "cuenta.v2.plan.premium_info": { ca: "Amb Premium accedeixes a tots els informes recents (últims 6 mesos), cross-reference complet amb les teves certificacions, accions recomanades i la newsletter completa. 29€/mes per als primers 50 subscriptors (early bird fins al novembre).", es: "Con Premium accedes a todos los informes recientes (últimos 6 meses), cross-reference completo con tus certificaciones, acciones recomendadas y la newsletter completa. 29€/mes para los primeros 50 suscriptores (early bird hasta noviembre)." },
  ...
  "cuenta.v2.newsletter.desc": { ca: "Reps la newsletter bimensual (cada 2 setmanes, els dijous a les 15:00h). Pots canviar l'idioma en qualsevol moment.", es: "Recibes la newsletter bimensual (cada 2 semanas, los jueves a las 15:00h). Puedes cambiar el idioma en cualquier momento." },
  "cuenta.v2.estandares.title": { ca: "Els meus estàndards ESG", es: "Mis estándares ESG" },
  "cuenta.v2.estandares.desc": { ca: "Selecciona els estàndards que ja té la teva empresa. Et recomanarem informes que t'afecten directament.", es: "Selecciona los estándares que ya tiene tu empresa. Te recomendaremos informes que te afectan directamente." },
  ...
  "cuenta.v2.intereses.desc": { ca: "Altres temes que t'interessen. Els fem servir per millorar les recomanacions de la newsletter.", es: "Otros temas que te interesan. Los usamos para mejorar las recomendaciones de la newsletter." },
