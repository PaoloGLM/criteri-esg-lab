...
export const translations = {
  ...
  "v2.popup.intro": {
    ca: "El semàfor no evalúa si un informe és bo o dolent. Evalúa si és útil per prendre decisions operatives en una empresa concreta. Ho fa en 5 dimensions, cadascuna amb nota verd, groga o vermella. La nota final es calcula amb una escala ponderada (verd=2, groc=1, vermell=0; màxim 10) i va d'A (robust fort) a D (insuficient).",
    es: "El semáforo no evalúa si un informe es bueno o malo. Evalúa si es útil para tomar decisiones operativas en una empresa concreta. Lo hace en 5 dimensiones, cada una con nota verde, amarilla o roja. La nota final se calcula con una escala ponderada (verde=2, amarillo=1, rojo=0; máximo 10) y va de A (robusto fuerte) a D (insuficiente).",
  },
  ...
  "v2.popup.grade.a.desc": { ca: "9-10 punts (5 verds)", es: "9-10 puntos (5 verdes)" },
  "v2.popup.grade.b.label": { ca: "Robust", es: "Robusto" },
  "v2.popup.grade.b.desc": { ca: "7-8 punts (4 verds + 1 groc)", es: "7-8 puntos (4 verdes + 1 amarillo)" },
  "v2.popup.grade.c.label": { ca: "Feble", es: "Débil" },
  "v2.popup.grade.c.desc": { ca: "5-6 punts (barreja amb fins a 1 vermell)", es: "5-6 puntos (mezcla con hasta 1 rojo)" },
  "v2.popup.grade.d.label": { ca: "Insuficient", es: "Insuficiente" },
  "v2.popup.grade.d.desc": { ca: "≤4 punts o 2+ vermells", es: "≤4 puntos o 2+ rojos" },
