...
export const reports: Report[] = [
  ...
  },
  {
    ...
    type: "official",
    scope: "ES",
    tags: ["Supervisió", "Mercat de valors", "Boletí mensual"],
    certifications: ["CNMV", "ESMA"],
    summary: "El boletí mensual de la CNMV recull registres, procediments sancionadors, comunicacions ASG i dades del mercat de valors espanyol.",
    url: "https://www.cnmv.es/portal/aldia/comunicaciones-publicas?fechaDesde=01/01/2026",
  },
  {
    slug: "cnmv-plan-actividades-2026",
    ...
    type: "official",
    scope: "ES",
    tags: ["Supervisió", "Plan d'activitats", "Governança"],
    certifications: ["CNMV", "ESMA"],
    summary: "La CNMV aprova el seu pla d'activitats 2026 amb objectius de supervisió i monitoratge ASG de les entitats supervisades.",
    url: "https://www.cnmv.es/portal/aldia/comunicaciones-publicas?fechaDesde=01/01/2026",
  },
  {
    slug: "eiopa-sustainable-finance-2026",
    ...
    type: "official",
    scope: "EU",
    tags: ["Assegurances", "Bretxa de protecció", "Risc climàtic"],
    certifications: ["EIOPA"],
    summary: "L'EIOPA analitza la bretxa de protecció asseguradora europea: 274.000M€ en pèrdues per catàstrofes, 124.000M€ assegurats.",
