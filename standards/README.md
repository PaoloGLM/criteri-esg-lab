# Fitxes d'expert dels estàndards ESG (INTERN)

> ⚠️ **Documents interns de Criteri ESG — NO PÚBLICS.**
...
- Revisió **mensual** o quan el pas 1 (detecció) trobi un canvi a les fonts oficials
- Els enllaços i dates han de ser **verificats** (mai inventats)

## Llista dels 16 estàndards
...
| 6 | `csddd.md` | ⏳ Pendent |
| 7 | `sfdr.md` | ⏳ Pendent |
| 8 | `taxonomia-ue.md` | ⏳ Pendent |
| 9 | `cdp.md` | ⏳ Pendent |
| 10 | `sge-21.md` | ⏳ Pendent |
| 11 | `sustainalytics.md` | ⏳ Pendent |
| 12 | `sasb.md` | ⏳ Pendent |
| 13 | `tnfd.md` | ⏳ Pendent |
| 14 | `tcfd.md` | ⏳ Pendent |
| 15 | `emas.md` | ⏳ Pendent |
| 16 | `iso-26000.md` | ⏳ Pendent |
